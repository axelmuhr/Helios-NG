...
/*
 *		SPECIF STRUCTURE / DEFINITIONS (dependent on type of romdisk)
 */
...
# define FILEBASEDFILE "romdir.fil"
#endif
...
/* static void 	getrombuffer (ROMINFO * );
static void 	extract_files (DirNode *, int); */
...
static ROMINFO * OpenRom (void)
{
	...
	r -> instream.rombuffer = p;	/* MRTOA_(vector_ptr); */
#ifdef DEBUG
...
#endif
#ifdef DEBUG
			IOdebug ("rom: extract_files () - offset = %d", offset);
#endif
...
#ifdef NEVER
		{
			char *	m = (char *)(&(RomInfo -> modhdr));
			int	o = 0;

			IOdebug ("rom: 0x%x 0x%x 0x%x 0x%x 0x%x 0x%x 0x%x 0x%x 0x%x 0x%x 0x%x 0x%x 0x%x 0x%x 0x%x 0x%x",
			    m[o + 0], m[o + 1], m[o + 2], m[o + 3], m[o + 4], m[o + 5], m[o + 6], m[o + 7], m[o + 8], m[o + 9],
			    m[o + 10], m[o + 11], m[o + 12], m[o + 13], m[o + 14], m[o + 15]);
			...
			IOdebug ("rom: 0x%x 0x%x 0x%x 0x%x 0x%x 0x%x 0x%x 0x%x 0x%x 0x%x 0x%x 0x%x", m[o + 0], m[o + 1],
			    m[o + 2], m[o + 3], m[o + 4], m[o + 5], m[o + 6], m[o + 7], m[o + 8], m[o + 9], m[o + 10], m[o + 11],
			    m[o + 12]);
