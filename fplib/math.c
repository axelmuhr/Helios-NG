...
/* opcodes and as such appear in "fpdirect.a"                               */
...
/* const double __huge_val = 1.79769313486231571e+308; __huge_val used in Acorn 0.4b versions */
#endif
#endif
...
/* I worry a little about signed zeros here. I hope that -0.0 == 0.0     */
    ...
    d1.d = d;
    n = 4*(d1.i.x - 0x40);        /* excess 64 exponent */ /* Check that I have the offset right here */
    d1.i.x = 0x40;
    d = d1.d;
...
#ifdef __HELIOSARM
 /* This function has been moved to "fpprintf.c" */
#else
double frexp(d, lvn)
double d; int *lvn;
{
...
#ifdef __HELIOSARM
 /* This function has been moved to "fprintf.c" */
#else
double ldexp(d, n)
double d; int n;
{
...
static double _tancot(double x, int iflag)
{
    int n;
...
static double _asinacos(double x, int flag)
{
    int i;
    double y, g, r;
...
#endif /* (NOT) HOST_HAS_TRIG */

/*--- following functions must be provided in a FPE based system ---*/
