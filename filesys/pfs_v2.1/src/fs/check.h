...
** 									**
** modified :  05/09/90  G.Lauven 	perihelion PFS			**
*************************************************************************/
...
#define  INFO		4		/* Some informations (variable  */
			...
			/*----- Different error codes for a termjmp ----*/
#define	 MEMERR		1		/* memory allocation error	*/
#define  READ_ERR	2		/* block read error		*/
#define  BAD_INFO_BLK	3		/* physically defect info block */
#define  BAD_SUM_BLK	4		/* physically defect summary block */
#define  WRITE_ERR	5		/* block write error		*/
#define  DIR_BLK_ERR	6		/* directory block IO-error	*/
#define  LNK_BLK_ERR	7		/* link block IO-error		*/
#define  IND_BLK_ERR	8		/* indirect block IO-error	*/
#define  DIND_BLK_ERR	9		/* double indirect block IO-error */
...
extern word cdev;			/* number of volume currently checked */
...
extern word maxbpg;			/* globals during check */
extern word maxncg;
...
word		 fscheck (word full, word delete_hanging_links, VD *vol);
