/* $Header: /dsl/HeliosARM/Working/./include/dev/serialdev.h,v 0.1 1993/12/10 12:13:33 nickc Exp $ */
/* $Source: /dsl/HeliosARM/Working/./include/dev/serialdev.h,v $ */
/************************************************************************/ 
...
/*
 * $Log: serialdev.h,v $
 * Revision 0.1  1993/12/10  12:13:33  nickc
 * .
 *
...
/* These abort functions allow the kernel to use a serial line as a link */
#define FS_AbortRead	 (FCP|FG_Abort|0x1)   /* Abort read operation	*/
#define FS_AbortWrite	 (FCP|FG_Abort|0x2)   /* Abort write operation	*/
