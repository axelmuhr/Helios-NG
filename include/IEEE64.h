 ...
 * Date :	$Date: 1992/07/02 09:05:28 $
 * Id :		$Id: IEEE64.h,v 1.1 1992/07/02 09:05:28 nickc Exp $
 */
 ...
 *
 * + Positive and negative infinity is NOT supported as a parameter
 ...
 *   As such it maps directly onto the C model of coparisons.
 */
...
IEEE64		_FNEGD( IEEE64 a );		   /* returns  -a */
...
IEEE64		_FSTOD( IEEE32 val );		   /* converts to   IEEE 32 bit format */
