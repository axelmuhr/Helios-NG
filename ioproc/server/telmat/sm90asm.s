...
#--      sm90asm.s                                                       --
#--                                                                      --
#--         Basic coroutine library functions for SM90, hacked from sun  --
#--         version fror a68 assembler by BLV and TJK.			 --
#--                                                                      --
#--     Author:  BLV                                                     --
#--                                                                      --
#------------------------------------------------------------------------*/
...
savemask = 0x3f3e		| May be CORRECT!!!
restmask = 0x7cfc
...
# size is in bytes
#==============================================================================
CreateCo:  moveml #savemask,sp@-      | save all registers
           ...
           moveml sp@+,#restmask      | else, restore registers
...
coenter:   moveml #savemask,sp@-      | save this coroutines registers
           movl   sp,a0@(co_sp)         | save stack pointer
           movl   a1@(co_sp),sp         | move to new coroutine stack
           moveml sp@+,#restmask      | restore registers
...
_InitCo: 
           movl   a6,sp@-
           movl  #co_SIZEOF,d0         | get root co-routine
           movw   d0,sp@-
           movl   d0,sp@-
