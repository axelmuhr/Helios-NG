...
--                                                                      --
------------------------------------------------------------------------*/
/* RcsId: $Id: serverxt.c,v 1.2 1994/05/12 10:13:20 nickc Exp $ */
...
#define fn(a) a
#else
#define fn(a) &a	/* XXX why is this needed ? K&R and ANSI both say name of fn is its addr */
#endif
/*}}}*/
...
#endif
{
	static	XtActionsRec actions[] = {
		{ "keypress",	fn(key_press)	},
		{ "focusin",	fn(focusin)	},
		{ "focusout",	fn(focusout)	},
		{ "expose",	fn(expose)	},
...
#endif
{
	...
	XtAppAddInput(ThisContext, ChildFd, XtInputReadMask, fn(from_ioserver), NULL);
