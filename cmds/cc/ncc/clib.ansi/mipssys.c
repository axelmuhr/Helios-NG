/* mipssys.c:  Copyright (C) Codemist Ltd         */
/* Very MIPS specific routines.		     */
...
#include "/users/jpff/ncc.include/sys/times.h"  /* for times             */
...
time_t time(time_t *timer)
{
  ...
  errno = 0;
  if (_syscall2(SYS_time, (int)&tv, NULL) == 0)	/* **** CHECK THIS *** */
