...
/*
 * RCS $Revision: 1.1 $
 * Checkin $Date: 1992/03/23 15:02:29 $
...
typedef void RProc(int32, VoidStar);
...
extern void vregset_map(VRegSetP set, RProc *dothis, VoidStar arg);
...
typedef void RProc2(VRegnum);
extern void vregset_map2(VRegSetP set, RProc2 *dothis);
...
typedef struct {
    AllocType  alloctype;
    unsigned32 *statloc,        /* called statSloc, statSbytes in a similar case */
               *statbytes;
} RelationAllocRec;
