/*
 * C compiler file aetree.c, version 35a
...
extern char aetree_version[];
char aetree_version[] = "\naetree.c $Revision: 1.1 $ 35a\n";
#endif
...
{
    return (Expr *) syn_list3(op, (int32)t, (int32)a1);
}

Expr *mk_expr2(AEop op, TypeExpr *t, Expr *a1, Expr *a2)
{
    return (Expr *) syn_list4(op, (int32)t, (int32)a1, (int32)a2);
}
...
{
    return (Expr *) syn_list5(op, (int32)t, (int32)a1, (int32)a2, (int32)a3);
}

#ifdef EXTENSION_VALOF
Expr *mk_expr_valof(AEop op, TypeExpr *t, Cmd *c)
{
    return (Expr *) syn_list3(op, (int32)t, (int32)c);
}
#endif

Expr *mk_exprwdot(AEop op, TypeExpr *t, Expr *a1, int32 a2)
{
    return (Expr *) syn_list4(op, (int32)t, (int32)a1, a2);
}

Expr *mk_exprbdot(AEop op, TypeExpr *t, Expr *a1, int32 a2, int32 a3,
                  int32 a4)
{
    return (Expr *) syn_list6(op, (int32)t, (int32)a1, a2, a3, a4);
}

DeclRhsList *mkDeclRhsList(DeclRhsList *a, Symstr *b, TypeExpr *c,
                           Expr *d, SET_BITMAP e, Binder *f)
{
    DeclRhsList *p = (DeclRhsList *) SynAlloc(sizeof(DeclRhsList));
    p->declcdr  = a;  p->declname = b;  p->decltype = c;
    p->declinit = d;  p->declstg  = e;  p->declbind = f;
...
case t_fnap:    pr_typeexpr(typearg_(x),s);
                ...
                eprintf(")");
                break;
default:        eprintf("[unrecognized typeexpr %ld]", (long)h0_(x));
                break;
        }
        elinebreak();
}
...
/* needed for $e in superrprintf ? no: too scrubby and writes to wrong file */
{   putc('"', stderr);
...
static void pr_list(int32 frep, VoidStar x)
{
        ...
        default:        eprintf("?");
                        break;
        case PR_CMD:    pr_cmd(cmdcar_((CmdList *)(int)x));
                        break;
        case PR_FORMTYPE:
                        pr_id(((FormTypeList *)(int)x)->ftname);
                        break;
        case PR_BIND:   pr_bind1(((BindList *)(int)x)->bindlistcar);
                        break;
                }
                eprintf(" ");
                elinebreak();
                x = (VoidStar) cdr_((List *)(int)x);
        }
}
#else
/*  We don't want this rubbish!!
