...
#endif
    {
        FileLine saved_fl = * pp_fl;    /*XXX NC - 11 May 1995 */
        ...
        {   ++pp_rdcnt;            /* which is    */
            ...
            *pp_fl = saved_fl;     /* XXX NC - 11 May 1995 */
 ...
 */
    ...
    /* Module being compiled is for a library => no module header */
    { "library_module",             'l', 1},
#endif
    { "profile",                    'p', 1},
