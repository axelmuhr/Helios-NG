...
#define bind_warn_unused_static_decl "\026§\013e\016liòKa\014c \266è\177\
W$r"    /* "unused earlier static declaration of $r" */
#define bind_warn_not_in_hdr "P˙ $r \136\266\016\013ùhead\003"    /* "extern $r not declared in header" */
#define bind_warn_main_not_int "P˙ \'í\001\033ne\005\015ü÷Ô\033®\030"    /* "extern 'main' needs to be 'int' function" */
#define bind_warn_label_not_used "lπ¢ $r wñ\224\013ﬂ\136§\005"    /* "label $r was defined but not used" */
/*
...
#define bind_warn_not_used(is_typedef,is_fn,binder) \
        "%s $b \266\016\013ﬂ\136§\005"    /* "%s $b declared but not used" */, \
      ((is_typedef) ? "typedef" : ((is_fn) ? "function" : "variable")),\
      binder
#define bind_warn_static_not_used "Ka\014c $b \266\016\013ﬂ\136§\005"    /* "static $b declared but not used" */
#define cg_warn_implicit_return "iõº©\020tÈn\213Ú\336Ä%s\050\051"    /* "implicit return in non-void %s()" */
#define flowgraf_warn_implicit_return "iõº©\020tÈn\213Ú\336Ä®\030"    /* "implicit return in non-void function" */
#define pp_warn_triglyph \
        "ANSI \'%c%c%c\033tr\204\314ph ß\'%c\033\321Ä\203wñË‹\240\035d\005\
\077"    /* "ANSI '%c%c%c' trigraph for '%c' found - was this intended?" */
#define pp_warn_nested_comment "\232èc\207\315ı\035c\002%s\023£Ò°mm»"    /* "character sequence %s inside comment" */
#define pp_warn_many_arglines \
        "\050ës£b´⁄\010\0515\076\075 %lu ◊ÂWícr\022‘\205»s"    /* "(possible error): >= %lu lines of macro arguments" */
#define pp_warn_redefinition "\020pe∑\224i\177W\043\224\002ícr\022%s"    /* "repeated definition of #define macro %s" */
#define pp_rerr_redefinition "diff\003\037r\005ef\001i\177W\043\224\002í\
cr\022%s"    /* "differing redefinition of #define macro %s" */
#define pp_rerr_nonunique_formal "d\316º\034\002ícr\022Ÿ\174Ó\0175\'%s\'"    /* "duplicate macro formal parameter: '%s'" */
#define pp_rerr_define_hash_arg "\313\0037ÄW\043 \136ícr\022Ÿ\174Ó\017"    /* "operand of # not macro formal parameter" */
#define pp_rerr_define_hashhash "\043\043 ªrs\004\032l\100\004tok\035\213\
\043\224\002body"    /* "## first or last token in #define body" */
#define pp_warn_ifvaldef "\043if\024\027%s íy\023dû\034\002tr\210bB\330"    /* "#ifdef %s may indicate trouble..." */ /* MACH_EXTNS */
#define pp_warn_nonansi_header "N”ANSI \043\001\215uÒ\074%s\076"    /* "Non-ANSI #include <%s>" */
#define pp_warn_bad_pragma "Un\020°gn\031\013\043p\314gí \050n\022\'-\033\
\032\026kQwn w\010d\051"    /* "Unrecognised #pragma (no '-' or unknown word)" */
#define pp_warn_bad_pragma1 "Un\020°gn\031\013\043p\314gí -%c"    /* "Unrecognised #pragma -%c" */
#define pp_warn_unused_macro "\043\224\002ícr\022\'%s\033\224\013ﬂ\136§\
\005"    /* "#define macro '%s' defined but not used" */
#define regalloc_warn_use_before_set "$b í\140÷§\013ó\002\037\315t"    /* "$b may be used before being set" */
#define regalloc_warn_never_used "$b ‹\315\004ﬂnevò§\005"    /* "$b is set but never used" */
#define sem_warn_unsigned "ANSI sÈpr\031e5\'l\007g\033$s \'\026s\216\005\
\033yi¢d\015\'l\007g\'"    /* "ANSI surprise: 'long' $s 'unsigned' yields 'long'" */
#define sem_warn_format_type "\377tu\011Yú\002$t m\031m\034\232Âóí\004\'\
%.\052s\'"    /* "actual type $t mismatches format '%.*s'" */
#define sem_warn_bad_format "Il\212\174óí\004êØ£\262\'%%%c\'"    /* "Illegal format conversion '%%%c'" */
#define sem_warn_incomplete_format "In°õBt\002óí\004Kr\342"    /* "Incomplete format string" */
#define sem_warn_format_nargs "F\010í\004\020ıi\020\015%ld Ó\017%s∏ﬂ%ld \
giv\035"    /* "Format requires %ld parameter%s, but %ld given" */
#define sem_warn_addr_array "\'\046\033\026nÅ\265s\016\140ß≈\032\016\314\
\140$e"    /* "'&' unnecessary for function or array $e" */
#define sem_warn_bad_shift(m,n) "shif„$m b\140%ld \026\224\013ùANSI C"    /* "shift of $m by %ld undefined in ANSI C" */,m,n
#define sem_warn_divrem_0 "div\031i\262b\140z\003o5$s"    /* "division by zero: $s" */
#define sem_warn_ucomp_0 "odÄ\026s\216\013°õ\016\031\262\340 05$s"    /* "odd unsigned comparison with 0: $s" */
#define sem_warn_fp_overflow(op) "…\034\037ï\004¯\004Ù…w5$s"    /* "floating point constant overflow: $s" */,op
#define sem_rerr_udiad_overflow(op,a,b,c) "\026s\216\013¯\004Ù…w5$s"    /* "unsigned constant overflow: $s" */,op
#define sem_rerr_diad_overflow(op,a,b,c) "s\216\013¯\004Ù…w5$s"    /* "signed constant overflow: $s" */,op
#define sem_rerr_umonad_overflow(op,a,b) "\026s\216\013¯\004Ù…w5$s"    /* "unsigned constant overflow: $s" */,op
#define sem_rerr_monad_overflow(op,a,b) "s\216\013¯\004Ù…w5$s"    /* "signed constant overflow: $s" */,op
#define sem_rerr_implicit_cast_overflow(t,a,b) \
                                "iõº©\264\004\050ü$tøÙ…w"    /* "implicit cast (to $t) overflow" */,t
#define sem_warn_fix_fail "…\034\037ü\240egr\174êØ£\262fa\036\005"    /* "floating to integral conversion failed" */
#define sem_warn_index_ovfl "\210t-of-bo\026Äoff\315\004%ld\213add\373s"    /* "out-of-bound offset %ld in address" */
#define sem_warn_low_precision "\176wòp\020c\031i\007\213widòêtPt5$s"    /* "lower precision in wider context: $s" */
#define sem_warn_odd_condition "§\002W$s\213êdi\177êtPt"    /* "use of $s in condition context" */
#define sem_warn_void_context "n\022£ÒeffÅ\004ù\336ÄêtPt5$s"    /* "no side effect in void context: $s" */
#define sem_warn_olde_mismatch "‘\205\035\0047Äold-Ky´Ó\207m\031m\034\232\
5$e"    /* "argument and old-style parameter mismatch: $e" */
#define sem_warn_uncheckable_format \
        "\'Ÿ\034\033‘.Y\022pr\240f\057sc7\027etc. ‹v\016iπB∏s\022c7\136÷\
\232Åk\005"    /* "'format' arg. to printf/scanf etc. is variable, so cannot be checked" */
#define sem_warn_narrowing "iõº©n\016Áw\037\264t5$s"    /* "implicit narrowing cast: $s" */
#define sem_warn_fn_cast \
        "$s5\264\004twe\035 ≈ï\2077ÄÚ≈objÅt"    /* "$s: cast between function pointer and non-function object" */
#define sem_warn_pointer_int "\246º©\264„∞Y\022Ô\'"    /* "explicit cast of pointer to 'int'" */
#define bind_err_extern_clash "P˙ \215\100h $r∏$r \050◊kò%ld \232\016%s\
\051"    /* "extern clash $r, $r (linker %ld char%s)" */
#define bind_err_duplicate_tag "d\316º\034\002\224i\177W$sYa\025$b"    /* "duplicate definition of $s tag $b" */
#define bind_err_reuse_tag "\020-§\037$sYa\025$b ñ$sYag"    /* "re-using $s tag $b as $s tag" */
#define bind_err_incomplete_tentative \
        "\001°õBt\002t»a\014v\002\266è\177W$r"    /* "incomplete tentative declaration of $r" */
#define bind_err_type_disagreement "\366d\031ag\020em\035\004ß$r"    /* "type disagreement for $r" */
#define bind_err_duplicate_definition "d\316º\034\002\224i\177W$r"    /* "duplicate definition of $r" */
#define bind_err_duplicate_label "d\316º\034\002\224i\177Wlπ¢ $r Í"    /* "duplicate definition of label $r - ignored" */
#define bind_err_unset_label "lπ¢ $r hñ\136\035 \315t"    /* "label $r has not been set" */
#define bind_err_undefined_static \
        "Ka\014c ≈$b \136\224\013-\375P˙"    /* "static function $b not defined - treated as extern" */
#define fp_err_very_big "OØl‘\002…\034\037ï\004˜\002\321d"    /* "Overlarge floating point value found" */
#define fp_err_big_single \
        "OØl‘\002\050s\342´p\020c\031i\007ø…\034\037ï\004˜\002\321d"    /* "Overlarge (single precision) floating point value found" */
#define pp_err_eof_comment "EOF\213°mm»"    /* "EOF in comment" */
#define pp_err_eof_string "EOF\213Kr\342"    /* "EOF in string" */
#define pp_err_eol_string "ıot\002\050%c\051\023s\003ìó\002new◊e"    /* "quote (%c) inserted before newline" */
#define pp_err_eof_escape "EOF\213Kr\037\265cape"    /* "EOF in string escape" */
#define pp_err_missing_quote "\374\'%c\'\213p\020-pÁc\265s\032°mm7Ä◊e"    /* "Missing '%c' in pre-processor command line" */
#define pp_err_if_defined "N\022i\024n\014ªòΩ\043i\027\224\005"    /* "No identifier after #if defined" */
#define pp_err_if_defined1 "N\022\'\051\033Ω\043i\027\224\005\050\330"    /* "No ')' after #if defined(..." */
#define pp_err_rpar_eof "\374\'\051\033Ω%s\050\330 \262◊\002%ld"    /* "Missing ')' after %s(... on line %ld" */
#define pp_err_many_args "TÛm7\140‘\205»\015üícr\022%s\050\330 \262◊\002\
%ld"    /* "Too many arguments to macro %s(... on line %ld" */
#define pp_err_few_args "TÛfew ‘\205»\015üícr\022%s\050\330 \262◊\002%l\
d"    /* "Too few arguments to macro %s(... on line %ld" */
#define pp_err_missing_identifier "\374i\024n\014ªòΩ\043\224e"    /* "Missing identifier after #define" */
#define pp_err_missing_parameter "\374Ó\207n‰\002ù\043\224\002%s\050\330"    /* "Missing parameter name in #define %s(..." */
#define pp_err_missing_comma "\374\',\033\032\'\051\033Ω\043\224\002%s\050\
\330"    /* "Missing ',' or ')' after #define %s(..." */
#define pp_err_undef "\374i\024n\014ªòΩ\043\026\211"    /* "Missing identifier after #undef" */
#define pp_err_ifdef "\374i\024n\014ªòΩ\043if\211"    /* "Missing identifier after #ifdef" */
#define pp_err_include_quote "\374\'\074\033\032\'\"\033Ω\043\001\215u\024"    /* "Missing '<' or '\"' after #include" */
#define pp_err_include_junk "J\026k Ω\043\001\215uÒ%c%s%c"    /* "Junk after #include %c%s%c" */
#define pp_err_include_file "\043\001\215uÒf\036\002%c%s%c w\210ldn\'\004\
...
#define sem_err_typeclash "Il\212\011YúÂß\313\0037ds5$s"    /* "Illegal types for operands: $s" */
#define sem_err_sizeof_struct "£z\002W$c ne\005\013ﬂ\136ye\004\224\005"    /* "size of $c needed but not yet defined" */
#define sem_err_lvalue "Il\212\011\213l˜e5≈\032\016\314\140$e"    /* "Illegal in lvalue: function or array $e" */
#define sem_err_bitfield_address "b©ª¢d\015d\022\136hav\002add\373s\265"    /* "bit fields do not have addresses" */
#define sem_err_lvalue1 "Il\212\011\213l-˜e5\'\035\205\033¯\004$b"    /* "Illegal in l-value: 'enum' constant $b" */
#define sem_err_lvalue2 "Il\212\011\023Yh\002êtP„7 l-˜e5$s"    /* "Illegal in the context of an l-value: $s" */
...
#define sem_err_nonfunction "\034teõ˘appl\140\376Ú®\030"    /* "attempt to apply a non-function" */
#define sem_err_void_argument "\'\336d\033˜Âí\140\136÷‘\205»s"    /* "'void' values may not be arguments" */
#define sem_err_bad_cast "$s5ƒ\264„$tY\022∞"    /* "$s: illegal cast of $t to pointer" */
#define sem_err_bad_cast1 "$s5ƒ\264˘$t"    /* "$s: illegal cast to $t" */
#define sem_err_bad_cast2 "$s5\264˘Úeı\174$t \231\011"    /* "$s: cast to non-equal $t illegal" */
#define sem_err_undef_struct \
        "$c \136ye\004\224\013\203c7\136÷\315BcìfÁm"    /* "$c not yet defined - cannot be selected from" */
#define sem_err_unknown_field "$c hñn\022$r ª¢d"    /* "$c has no $r field" */
...
#define bind_rerr_linkage_disagreement \
        "◊kag\002d\031ag\020em\035\004ß$r -\375$m"    /* "linkage disagreement for $r - treated as $m" */
#define bind_rerr_local_extern "P˙ $r m\031m\034\232Ât\313-Bv¢ \266è\030"    /* "extern $r mismatches top-level declaration" */
#define fp_rerr_very_small "sm\011l …\034\037ï\004˜\002êØìü0.0"    /* "small floating point value converted to 0.0" */
#define fp_rerr_small_single \
        "sm\011l \050s\342´p\020c\031i\007ø…\034\037˜\002êØìü0.0"    /* "small (single precision) floating value converted to 0.0" */
#define pp_rerr_newline_eof "mÌnew◊\002ó\002EOF -\023s\003t\005"    /* "missing newline before EOF - inserted" */
#define pp_rerr_nonprint_char "\026pr\240π´\232\016 %\043.2x \321ÄÍ"    /* "unprintable char %#.2x found - ignored" */
#define pp_rerr_illegal_option "ƒ\313\177-D%s%s"    /* "illegal option -D%s%s" */
#define pp_rerr_spurious_else "spÈi\210\015\043¢s\002\261"    /* "spurious #else ignored" */
#define pp_rerr_spurious_elif "spÈi\210\015\043¢i\027\261"    /* "spurious #elif ignored" */
#define pp_rerr_spurious_endif "spÈi\210\015\043\035di\027\261"    /* "spurious #endif ignored" */
#define pp_rerr_hash_line "n\205bòm’\342\213\043◊e"    /* "number missing in #line" */
#define pp_rerr_hash_error "\043⁄\032\035°\026\017\013\"%s\""    /* "#error encountered \"%s\"" */
#define pp_rerr_hash_ident "\043i\024n\004‹\136ùANSI C"    /* "#ident is not in ANSI C" */
#define pp_rerr_junk_eol "j\026k a\004\035ÄW\043%s ◊\002Í"    /* "junk at end of #%s line - ignored" */
#define sem_rerr_sizeof_bitfield \
        "£zeW\074b©ª¢d\254ƒ\203£zeof\050\240ø\322\005"    /* "sizeof <bit field> illegal - sizeof(int) assumed" */
#define sem_rerr_sizeof_void "£z\002W\'\336d\033\020ıir\013-\3751"    /* "size of 'void' required - treated as 1" */
#define sem_rerr_sizeof_array "£z\002W\376\133\135 \016\314\140\020ıir\005\
,\375\1331\135"    /* "size of a [] array required, treated as [1]" */
#define sem_rerr_sizeof_function \
        "£z\002W≈\020ıir\013-\375£z\002W∞"    /* "size of function required - treated as size of pointer" */
...
#define sem_rerr_assign_const "≥\216m\035˘\'Î\033objÅ\004$e"    /* "assignment to 'const' object $e" */
#define sem_rerr_addr_regvar \
        "\'\020g\031\017\033\034tri¿t\002ß$b ™\013wh\035 add\373\015tak\
\035"    /* "'register' attribute for $b ignored when address taken" */
#define sem_rerr_lcast "objÅt\015Ëa\004hav\002\035 \264\004\016\002\136\
l-˜\265"    /* "objects that have been cast are not l-values" */
#define sem_rerr_pointer_compare \
"°õ\016\031\262$s Wï\2077d\023t:\næli\017\1740 \050ß\075\075 7Ä\041\075ø\
‹\007l\140\212\174\264e"    /* "comparison $s of pointer and int:\n\
  literal 0 (for == and !=) is only legal case" */
#define sem_rerr_different_pointers "diff\003\037∞Yú\2655$s"    /* "differing pointer types: $s" */
#define sem_rerr_wrong_no_args "wr\007\025n\205bòWÓ\017\015ü$e"    /* "wrong number of parameters to $e" */
#define sem_rerr_implicit_cast1 \
        "$s5iõº©\264„∞Y\022Úeı\174∞"    /* "$s: implicit cast of pointer to non-equal pointer" */
#define sem_rerr_implicit_cast2 "$s5iõº©\264„Ú0\023˘∞"    /* "$s: implicit cast of non-0 int to pointer" */
#define sem_rerr_implicit_cast3 "$s5iõº©\264„∞Y\022Ô\'"    /* "$s: implicit cast of pointer to 'int'" */
#define sem_rerr_implicit_cast4 "$s5iõº©\264„$tY\022Ô\'"    /* "$s: implicit cast of $t to 'int'" */
#define sem_rerr_cant_balance "diff\003\037∞Yú\2655$s"    /* "differing pointer types: $s" */

#define sem_rerr_void_indirection "\231\011\023di\020c\177\262\050\336Ä\
\052\0515\'\052\'"    /* "illegal indirection on (void *): '*'" */
#define obj_fatalerr_io_object "I\057O ⁄\032\262objÅ\004K\020‰"    /* "I/O error on object stream" */
#define compiler_rerr_no_extern_decl\
    "n\022P˙\174\266è\030\023Yr7sla\177\026\206"    /* "no external declaration in translation unit" */
#define compiler_fatalerr_io_error "I\057O ⁄\032wr\206\037\'%s\'"    /* "I/O error writing '%s'" */
#define driver_fatalerr_io_object "I\057O ⁄\032\262objÅ\004K\020‰"    /* "I/O error on object stream" */
#define driver_fatalerr_io_asm "I\057O ⁄\032\262≥emblò\210tpu\004K\020‰"    /* "I/O error on assembler output stream" */
#define driver_fatalerr_io_listing "I\057O ⁄\032\262l\031t\037K\020‰"    /* "I/O error on listing stream" */
#ifdef TARGET_HAS_AOUT
#define aout_fatalerr_toomany "TÛm7\140symbol\015ß\'a.\210t\033\210tput"    /* "Too many symbols for 'a.out' output" */
#define aout_fatalerr_toobig "Modu´tÛbi\025ßa.\210\004Ÿ\034\017"    /* "Module too big for a.out formatter" */
#endif
#ifdef TARGET_HAS_COFF
#define coff_fatalerr_toomany "TÛm7\140\020\176ca\030\015ßCOFF óí\004ù.\
\022f\036e"    /* "Too many relocations for COFF format in .o file" */
#define coff_fatalerr_toobig "Modu´tÛbi\025ßCOFF Ÿ\034\017"    /* "Module too big for COFF formatter" */
#endif
...
#endif
#define misc_fatalerr_space1 "\210„K\010\002\050ß⁄\032¿ff\003\051"    /* "out of store (for error buffer)" */
#define misc_fatalerr_toomanyerrs "TÛm7\140⁄\010s"    /* "Too many errors" */
#define misc_fatalerr_space2 "\210„K\010\002\050ùcc\137\011\176c\051\n\050\
Coõ\036a\177WË\002\024¿gg\037tπB\015\020ıeK\013\340Yh\002-\025\313\030\n \
\020ıi\020\015\376g\020a\004\024\174WÆm\010y. RÅoõ\036\037\340\210\004-\
g∏\340\nYh\002m\010\002\020Krûì-g\027\313\030∏\032\340Yh\002pÁg\314m bÁ\
k\035\023to\n sm\011lòpiÅ\265∏í\140h¢p.\051"    /* "out of store (in cc_alloc)\n\
...
#define driver_message_readfail "C\210ldn\'\004\020aÄf\036\002\'%s\'\n"    /* "Couldn't read file '%s'\n" */
/* NB the next error can not arise with the current ARM driver */
#define driver_message_toomanyfiles "TÛm7\140f\036\002‘s"    /* "Too many file args" */
#define driver_message_asmstdout "As\315mbl\140°Òw\036l g\022üKd\210t\n"    /* "Assembly code will go to stdout\n" */
...
#define driver_message_nomap "-m f\036\002\136ava\036π´\032c\010r\316\004\
Í\n"    /* "-m file not available or corrupt - ignored\n" */
#define driver_message_notest \
        "Th‹Ø£\262WË\002°õ\036òdoÂ\136s\316p\010\004Ë\002-t\265\004\313\
...
#endif
#define driver_message_testfile "N\022f\036Â\011\176w\013\340 -teK\n"    /* "No files allowed with -test\n" */
...
#define warn_untrustable "\026truKπ´°Òg\035\003∑ß%s"    /* "untrustable code generated for %s" */
#endif
...
#define lex_warn_force_unsigned "%s\375%sul\21332-b©iõBm»a\030"    /* "%s treated as %sul in 32-bit implementation" */
#define lex_warn_multi_char "Úp\010tπ´\203\1361 \232\016\213\'\330\'"    /* "non-portable - not 1 char in '...'" */

#define syn_warn_hashif_undef "Un\224\013ícr\022\'%s\'\213\043i\027-\375\
...
#define syn_warn_unary_plus "Un\016\140\'\053\033‹\376fe\034È\002WANSI \
C"    /* "Unary '+' is a feature of ANSI C" */
#define syn_warn_spurious_braces "spÈi\210\015\173\175 \016o\026Äsc\011\
\016\023\312\003"    /* "spurious {} around scalar initialiser" */
#define syn_warn_dangling_else "D7gl\037\'¢\315\'\023dû\034Âës£b´⁄\010"    /* "Dangling 'else' indicates possible error" */
#define syn_warn_void_return "Ú˜\002\020tÈn\213Ú\336Ä®\030"    /* "non-value return in non-void function" */
#define syn_warn_use_of_short \
        "\'sh\010t\033s\176w\003Yh7 Ô\033\007Yh‹í\232\001\002\050\315\002\
m7u\011\051"    /* "'short' slower than 'int' on this machine (see manual)" */
#define syn_warn_enum_unchecked "N\022\366\232Åk\037W\'\035\205\'\023Yh\
‹°õ\036\003"    /* "No type checking of 'enum' in this compiler" */
#define syn_warn_undeclared_parm \
        "Ÿ\174Ó\207$r \136\266\016\013\203Ô\033\322\005"    /* "formal parameter $r not declared - 'int' assumed" */
#define syn_warn_old_style "Old-Ky´≈$r"    /* "Old-style function $r" */
#define syn_warn_give_args "Dep\020c∑\266è\177%s\050ø\203giv\002\016\025¡\
\265"    /* "Deprecated declaration %s() - give arg types" */
#define syn_warn_ANSI_decl "ANSI Ky´≈\266è\177§\005∏\'%s\050\330\051\'"    /* "ANSI style function declaration used, '%s(...)'" */
#define syn_warn_archaic_init "Anci\035\004Ÿ of\023\312a\030∏§\002\'\075\'"    /* "Ancient form of initialisation, use '='" */
#define syn_warn_untyped_fn "\'\001\004%s\050\051\033\322\013\203\'\336\
d\'\023t\035d\005\077"    /* "'int %s()' assumed - 'void' intended?" */
#define syn_warn_no_named_member "$c hñn\022n‰\013Æmb\003"    /* "$c has no named member" */
#define syn_warn_extra_comma "S\316\003flu\210\015\',\'\213\'\035\205\033\
\266è\030"    /* "Superfluous ',' in 'enum' declaration" */

#define vargen_warn_nonull "om\206t\037t\314\036\037\'\\0\033ß%s \133%l\
d\135"    /* "omitting trailing '\\0' for %s [%ld]" */
#define vargen_warn_unnamed_bitfield \
        "Unn‰\013b©ª¢d\023\312\013ü0"    /* "Unnamed bit field initialised to 0" */

#define lex_err_ioverflow "N\205bò%sYÛl‘\002ß32-b©iõBm»a\030"    /* "Number %s too large for 32-bit implementation" */
#define lex_err_overlong_fp "GÁssl\140Ù-l\007\025…\034\037ï\004n\205b\003"    /* "Grossly over-long floating point number" */
#define lex_err_fp_syntax1 "D\204©\020ıir\013Ω\246\007\035\004m\016k\003"    /* "Digit required after exponent marker" */
#define lex_err_overlong_hex "GÁssl\140Ù-l\007\025hPa\024cim\174¯t"    /* "Grossly over-long hexadecimal constant" */
#define lex_err_overlong_int "GÁssl\140Ù-l\007\025n\205b\003"    /* "Grossly over-long number" */
#define lex_err_need_hex_dig "HP d\204©ne\005\013Ω0x \0320X"    /* "Hex digit needed after 0x or 0X" */
#define lex_err_need_hex_dig1 "\374hP d\204\206\050søΩ\\x"    /* "Missing hex digit(s) after \\x" */
#define lex_err_backslash_blank \
        "\\\074sp\377e\2547Ä\\\074tπ\254\016\002\001\317iÄKr\037\265cap\
\265"    /* "\\<space> and \\<tab> are invalid string escapes" */
#define lex_err_unterminated_string "New◊\002\032\035ÄWf\036\002\340ùKr\
\342"    /* "Newline or end of file within string" */
#define lex_err_bad_hash "m\031pl\377\013p\020pÁc\265s\032\232èc\207\'%\
c\'"    /* "misplaced preprocessor character '%c'" */
#define lex_err_bad_char "ƒ\232èc\207\0500x%lx \075 \'%c\'\051\213s\210\
rce"    /* "illegal character (0x%lx = \'%c\') in source" */
#define lex_err_bad_noprint_char "ƒ\232èc\207\050hP °Ò0x%x\051\213s\210\
rce"    /* "illegal character (hex code 0x%x) in source" */
#define lex_err_ellipsis "\050\330øm§\004hav\002P\377tl\1403 dots"    /* "(...) must have exactly 3 dots" */
#define lex_err_illegal_whitespace "$s í\140\136hav\002wh\206\265p\377\002\
ù\206"    /* "$s may not have whitespace in it" */

#define syn_err_bitsize "b©£z\002%ld ƒ\2031 \322\005"    /* "bit size %ld illegal - 1 assumed" */
#define syn_err_zerobitsize "z\003\022widË n‰\013b©ª¢Ä\2031 \322\005"    /* "zero width named bit field - 1 assumed" */
#define syn_err_arraysize "Ar\314\140£z\002%ld ƒ\2031 \322\005"    /* "Array size %ld illegal - 1 assumed" */
#define syn_err_expected "Ï$s -\023s\003ìó\002$l"    /* "expected $s - inserted before $l" */
#define syn_err_expected1 "Ï$s%s -\023s\003ìó\002$l"    /* "expected $s%s - inserted before $l" */
#define syn_err_expected2 "Ï$s \032$s -\023s\003ì$s ó\002$l"    /* "expected $s or $s - inserted $s before $l" */
#define syn_err_expecteda "Ï$s"    /* "expected $s" */
#define syn_err_expected1a "Ï$s%s"    /* "expected $s%s" */
#define syn_err_expected2a "Ï$s \032$s"    /* "expected $s or $s" */
#define syn_err_mix_strings "\232\016 7ÄwiÒ\050L\"\330\"øKr\342\015d\022\
\136êc\034\035\034e"    /* "char and wide (L\"...\") strings do not concatenate" */
#define syn_err_expected_expr "\074\246\373£\007\254Ïﬂ\321Ä$s"    /* "<expression> expected but found $s" */
#define syn_err_type_needed "\366n‰\002\246Åt\005"    /* "type name expected" */
...
#endif
#define syn_err_typedef "¡\005e\027n‰\002$r §\013ù\246\373£\262êtPt"    /* "typedef name $r used in expression context" */
#define syn_err_assertion "\137\137\137≥\003t\0500∏$e\051"    /* "___assert(0, $e)" */
#define syn_err_expected_id "Exp\320\074i\024n\014ª\003\254Ω$s ﬂ\321Ä$l"    /* "Expected <identifier> after $s but found $l" */
#define syn_err_hashif_eof "EOF \136new◊\002Ω\043i\027\330"    /* "EOF not newline after #if ..." */
#define syn_err_hashif_junk "J\026k Ω\043i\027\074\246\373£\007\076"    /* "Junk after #if <expression>" */
#define syn_err_initialisers "tÛm7y\023\312\003\015ù\173\175 ßagg\020g\034\
...
#define syn_err_default "\'\211ault\033\136ùs¬\232 Í"    /* "'default' not in switch - ignored" */
#define syn_err_default1 "d\316º\034\002\'\211ault\033\264\002\261"    /* "duplicate 'default' case ignored" */
#define syn_err_case "\'\264e\033\136ùs¬\232 Í"    /* "'case' not in switch - ignored" */
#define syn_err_case1 "d\316º∑\264\002¯t5%ld"    /* "duplicated case constant: %ld" */
#define syn_err_expected_cmd "\074°mm7d\254Ïﬂ\321Ä\376$s"    /* "<command> expected but found a $s" */
#define syn_err_expected_while "\'wh\036e\033ÏΩ\'do\033\203\321Ä$l"    /* "'while' expected after 'do' - found $l" */
#define syn_err_else "M\031pl\377\013\'¢\315\033\261"    /* "Misplaced 'else' ignored" */
#define syn_err_continue "\'êt\001ue\033\136ù\176\313 Í"    /* "'continue' not in loop - ignored" */
#define syn_err_break "\'b\020ak\033\136ù\176\313 \032s¬\232 Í"    /* "'break' not in loop or switch - ignored" */
#define syn_err_no_label "\'goto\033\136≠l\176w\013b\140lπ¢ Í"    /* "'goto' not followed by label - ignored" */
#define syn_err_no_brace "\'\173\033W≈bod\140Ï\203\321Ä$l"    /* "'{' of function body expected - found $l" */
#define syn_err_stgclass \
        "K\010ag\002\215\100\015$s \136p\003m\206ìùêtP\004%s Í"    /* "storage class $s not permitted in context %s - ignored" */
#define syn_err_stgclass1 "K\010ag\002\215\100\015$s\023°õa\014b´\340 $\
m Í"    /* "storage class $s incompatible with $m - ignored" */
#define syn_err_typeclash "\366$s\023ês\031t\035\004\340 $m"    /* "type $s inconsistent with $m" */
#define syn_err_tag_brace \
        "\'\173\033\032\074i\024n\014ª\003\254ÏΩ$s∏ﬂ\321Ä$l"    /* "'{' or <identifier> expected after $s, but found $l" */
#define syn_err_expected3 "ExpÅt\037\074\266\016\034\010\254\032\074¡e\076\
∏ﬂ\321Ä$l"    /* "Expecting <declarator> or <type>, but found $l" */
#define syn_err_unneeded_id \
        "I\024n\014ªò\050%sø\321d\213\074πK\314c\004\266\016\034\010\254\
Í"    /* "Identifier (%s) found in <abstract declarator> - ignored" */
...
#define syn_err_selfdef_struct(m,b,s) \
        "\034teõ˘\001\215uÒ$c %s5$r \340ù\206s¢f"    /* "attempt to include $c %s: $r within itself" */, \
        b, errs_membobj(m), s
#define syn_err_void_object(m,s) "ƒ\'\336d\033%s5$r"    /* "illegal 'void' %s: $r" */, errs_membobj(m), s
#define syn_err_duplicate_type \
        "d\316º\034\002\366spÅifûa\177WŸ\174Ó\207$r"    /* "duplicate type specification of formal parameter $r" */
#define syn_err_not_a_formal "N”Ÿ\174$r\213Ó\017-¡e-spÅiª\003"    /* "Non-formal $r in parameter-type-specifier" */
#define syn_err_cant_init "$m v\016iπB\015í\140\136÷\001\312\005"    /* "$m variables may not be initialised" */
#define syn_err_enumdef \
        "\074i\024n\014ª\003\254Ïﬂ\321Ä$l\213\'\035\205\033\224i\030"    /* "<identifier> expected but found $l in 'enum' definition" */
#define syn_err_misplaced_brace "M\031pl\377\013\'\173\033a\004t\313 Bv\
¢ \203™\037b\176ck"    /* "Misplaced '{' at top level - ignoring block" */

#define vargen_err_long_string "Kr\342\023\312òl\007g\003Yh7 %s \133%ld\
\135"    /* "string initialiser longer than %s [%ld]" */
#define vargen_err_nonstatic_addr \
        "ÚKa\014c add\373\015$b\213∞\023\312\003"    /* "non-static address $b in pointer initialiser" */
#define vargen_err_bad_ptr "$s5ƒ§\002ù∞\023\312\003"    /* "$s: illegal use in pointer initialiser" */
#define vargen_err_init_void "objÅt\015W\366\'\336d\033c7 \136÷\001\312\
\005"    /* "objects of type 'void' can not be initialised" */
#define vargen_err_undefined_struct \
        "$c m§\004÷\224\013ß\050Ka\014cøv\016iπ´\266è\030"    /* "$c must be defined for (static) variable declaration" */
#define vargen_err_open_array "Un\001\312\013Ka\014c \133\135 \016\314y\015\
\231\011"    /* "Uninitialised static [] arrays illegal" */
#define vargen_err_overlarge_reg "g\176b\174\020g\031\207n\205b\003YÛl‘\
e"    /* "global register number too large" */
#define vargen_err_not_int "\001\317idYú\002ßg\176b\011\023\004\020g\031\
\017"    /* "invalid type for global int register" */
#define vargen_err_not_float "\001\317idYú\002ßg\176b\174…a\004\020g\031\
...
#endif
#ifdef TARGET_IS_HELIOS
#define vg_err_dynamicinit "In\312\013dyn‰û \016\314\140\340 -ZR \032-Z\
L"    /* "Initialised dynamic array with -ZR or -ZL" */
#endif
#define vargen_rerr_nonaligned \
        "N”\011\216\013ADCON a\004d\034a\0530x%lx \050˜\002$r\0530x%lxø\
\315˘NULL"    /* "Non-aligned ADCON at data+0x%lx (value $r+0x%lx) set to NULL" */
#define vargen_rerr_datadata_reloc \
       "RISC OS \050\032oË\003ø\020»r7\004modu´hñKa\014c\023\206.Y\022d\
...
#define lex_rerr_pp_number "n\205bò\231\011l\140≠l\176w\013b\140Bt\017"    /* "number illegally followed by letter" */
#define lex_rerr_hex_exponent "hP n\205bòc7\136hav\002\246\007»"    /* "hex number cannot have exponent" */
#define lex_rerr_esc16_truncated \
        "Ùl‘\002\265cap\002\'\\x%s%lx\033t\341\'\\x%lx\'"    /* "overlarge escape '\\x%s%lx' treated as '\\x%lx'" */
#define lex_rerr_esc8_truncated "Ùl‘\002\265cap\002\'\\%o\033t\341\'\\%\
o\'"    /* "overlarge escape '\\%o' treated as '\\%o'" */
#define lex_rerr_illegal_esc "ƒKr\037\265cap\002\'\\%c\033-\375%c"    /* "illegal string escape '\\%c' - treated as %c" */
#define lex_rerr_not1wchar "L\'\330\033ne\005\015P\377tl\1401 wiÒ\232èc\
\017"    /* "L'...' needs exactly 1 wide character" */
#define lex_rerr_empty_char "n\022\232\016\015ù\232èc\207¯\004\'\'"    /* "no chars in character constant ''" */
#define lex_rerr_overlong_char "m\010\002Ë7 4 \232\016\015ù\232èc\207¯t"    /* "more than 4 chars in character constant" */

#define syn_rerr_array_0 "\016\314\140\1330\135 \321d"    /* "array [0] found" */
#ifdef EXTENSION_VALOF
#define syn_rerr_void_valof "\336Ä\317Wb\176ck\015\016\002\136p\003m\206\
t\005"    /* "void valof blocks are not permitted" */
#endif
#define syn_rerr_undeclared "\026\266\016\013naÆ,\023v»\037\'P˙\023\004\
%s\'"    /* "undeclared name, inventing 'extern int %s'" */
#define syn_rerr_insert_parens \
        "p\016»h\265Â\050\214\051\023s\003ì\016o\026Ä\246\373£\262≠l\176\
w\037$s"    /* "parentheses (..) inserted around expression following $s" */
#define syn_rerr_return "\020tÈn \074\246r\254ƒß\336Ä®\030"    /* "return <expr> illegal for void function" */
#define syn_rerr_qualified_typedef(b,m) \
        "$mYú\005e\027$b hñ$m \020-spÅiª\005"    /* "$m typedef $b has $m re-specified" */, m, b, m
#define syn_rerr_missing_type "mÌ\366spÅifûa\177\203Ô\033\322\005"    /* "missing type specification - 'int' assumed" */
#define syn_rerr_long_float "ANSI C doÂ\136s\316p\010\004\'l\007\025…\034\'"    /* "ANSI C does not support 'long float'" */
#define syn_rerr_missing_type1 \
        "om\206ì\074¡e\254ó\002Ÿ\174\266\016\034\032\203Ô\033\322\005"    /* "omitted <type> before formal declarator - 'int' assumed" */
#define syn_rerr_missing_type2 \
        "≈pÁto\366Ÿ\174$r ne\005\015\366\032\215\100\015\203Ô\033\322\005"    /* "function prototype formal $r needs type or class - 'int' assumed" */
#define syn_rerr_ellipsis_first "¢lip£\015\050\330øc7\136÷\007l\140Ó\017"    /* "ellipsis (...) cannot be only parameter" */
#define syn_rerr_mixed_formals "pÁto\3667Äold-Ky´Ó\017\015mix\005"    /* "prototype and old-style parameters mixed" */
#define syn_rerr_open_member "ƒ\133\135 Æmb\0035$r"    /* "illegal [] member: $r" */
#define syn_rerr_fn_returntype "≈\020tÈn\037$t ƒ-\203\322\037∞"    /* "function returning $t illegal -- assuming pointer" */
#define syn_rerr_array_elttype "\016\314\140W$t ƒ-\203\322\037∞"    /* "array of $t illegal -- assuming pointer" */
#define syn_rerr_fn_ptr(m,s) \
   "%s $r í\140\136÷≈-\203\322\037∞"    /* "%s $r may not be function -- assuming pointer" */, errs_membobj(m), s
#define syn_rerr_fn_ptr1 \
        "≈$r í\140\136÷\001\312\013\203\322\037≈∞"    /* "function $r may not be initialised - assuming function pointer" */
#define syn_rerr_archaic_init "Anci\035\004Ÿ of\023\312a\030∏§\002\'\075\'"    /* "Ancient form of initialisation, use '='" */
#define syn_rerr_bitfield "ƒb©ª¢dYú\002$t \203Ô\033\322\005"    /* "illegal bit field type $t - 'int' assumed" */
#define syn_rerr_missing_formal "Ÿ\174n‰\002m’\342\213≈\224i\030"    /* "formal name missing in function definition" */
#define syn_rerr_ineffective "\266è\177\340 n\022effÅt"    /* "declaration with no effect" */
#define syn_rerr_duplicate_member(sv,b) "d\316º\034\002Æmbò$r W$c"    /* "duplicate member $r of $c" */, sv, b
#define syn_rerr_missing_type3 \
        "\366\032\215\100\015ne\005\013\050Pcep\004ù≈\224i\030ø\203Ô\033\
\322\005"    /* "type or class needed (except in function definition) - 'int' assumed" */
#define syn_rerr_semicolon_in_arglist \
        "\',\033\050\136\'\073\'ø\315p\016\034ÂŸ\174Ó\017s"    /* "',' (not ';') separates formal parameters" */
#define syn_rerr_no_members "$c hñn\022Æmb\003s"    /* "$c has no members" */
 ...
 */
#define misc_disaster_banner   "\n√√√√Ç\052\n\052 Th\002°õ\036òhñ\024t\320\
7\023˙\011\023ês\031t\035cy.æTh‹c7 occÈæ\052\n\052 bÅa§\002©hñr\026 \210„\
\376v\206\174\373\210rc\002su\232 ñÆm\010\140\032d\031kææ \052\n\052 sp\
\377\002\032bÅa§\002Ë\003\002‹\376faul\004ù\206.æI\027y\210 c7\136e\100\
\036\140\011\207 \052\n\052 y\210r pÁg\314mY\022a\336Äca§\037Ë‹r\016\002\
fa\036u\020∏pB\100\002êt\377\004y\210ræ\052\n\052 \024\011\003.æTh\002\024\011\
òí\140÷π´üh¢p y\210 imm\005i\034¢\1407Äw\036l ÷æ\052\n\052 π´ü\020p\010\
\004\376s§p\320°õ\036òfaul˘Ë\002s\316p\010\004c»\020.æææ\052\n√√√√Ç\052\n\n"    /* "\n\
*************************************************************************\n\
