...
#include "xpuops.h"
#include "cg.h"
/* $Id: cg2.c,v 1.4 1993/07/05 10:45:37 nick Exp $ */
 ...
 */
void cg_indirect(x,flag,mcmode_arg,mclength_arg,valneeded)
Expr *x;
const int flag, mcmode_arg, mclength_arg,valneeded;
{
	VLocal *v1 = NULL;
	VLocal *v2 = NULL;
	Expr *x1, *x2 = NULL;
	int offset = 0, postinc = 0;
	int mcmode = mcmode_arg;
	int mclength = mclength_arg;
	const RegSort rsort = mcmode_arg!=2 ? INTREG : 
				(mclength_arg==4 ? FLTREG : DBLREG);
	int d = depth(x);
	int scaled = FALSE;
 ...
 */
static void cg_var(b,flag,mcmode,mclength,valneeded)
Binder *b;
AEop flag;
...
static void cg_storein(e,flag,valneeded)
Expr *e;
AEop flag; 
int valneeded;
{
