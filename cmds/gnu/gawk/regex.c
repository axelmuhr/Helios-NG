...
int
re_search (pbufp, strng, size, startpos, range, regs)
     struct re_pattern_buffer *pbufp;
     char *strng;
     int size, startpos, range;
     struct re_registers *regs;
{
  return re_search_2 (pbufp, (char *) 0, 0, strng, size, startpos, range, 
		      regs, size);
}
...
int
re_match (pbufp, strng, size, pos, regs)
     struct re_pattern_buffer *pbufp;
     char *strng;
     int size, pos;
     struct re_registers *regs;
{
  return re_match_2 (pbufp, (char *) 0, 0, strng, size, pos, regs, size); 
}
#endif /* not emacs */
