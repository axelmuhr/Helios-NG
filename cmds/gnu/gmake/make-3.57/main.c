...
static char *rcsid = "$Header: /usr/perihelion/Helios/cmds/gnu/gmake/make-3.57/RCS/main.c,v 1.1 90/08/28 14:38:44 james Exp $";
...
/* The structure that describes an accepted command switch.  */
    enum STYPE		/* Type of the value.  */
      {
	flag,		/* Turn int flag on.  */
	flag_off,	/* Turn int flag off.  */
	mstring,		/* One string per switch, may be in the same word.  */
...
static struct command_switch switches[] =
  {
    { 'b', ignore, 0, 0, 0, 0, 0 },
    { 'C', mstring, (char *) &directories, 0, 0, 0, 0 },
    { 'd', flag, (char *) &debug_flag, 1, 1, 0, 0 },
    { 'e', flag, (char *) &env_overrides, 1, 1, 0, 0 },
    { 'f', mstring, (char *) &makefiles, 0, 0, 0, 0 },
    { 'i', flag, (char *) &ignore_errors_flag, 1, 1, 0, 0 },
    { 'I', mstring, (char *) &include_directories, 0, 0, 0, 0 },
    ...
    { 'o', mstring, (char *) &old_files, 0, 0, 0, 0 },
    ...
    { 'W', mstring, (char *) &new_files, 0, 0, 0, 0 },
    { '\0', ignore, 0, 0, 0, 0 }
  };
