a/* Variable expansion functions for GNU Make.
...
static char *rcsid = "$Header: /usr/perihelion/Helios/cmds/gnu/gmake/make-3.57/RCS/expand.c,v 1.1 90/08/28 14:33:35 james Exp $";
