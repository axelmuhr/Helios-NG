/* $Header: /usr/perihelion/Helios/cmds/gnu/gmake/make-3.57/RCS/file.h,v 1.1 90/08/28 14:34:43 james Exp $ */
...
enum CSTATE			/* State of the commands.  */
...
struct file
  {
    ...
    enum CSTATE command_state ENUM_BITFIELD (2);
