...
static char *rcsid = "$Header: /usr/perihelion/Helios/cmds/gnu/gmake/make-3.57/RCS/variable.c,v 1.1 90/08/28 14:44:33 james Exp $";
...
#else
  v = define_variable ("SHELL", 5, "/helios/bin/shell", o_default, 0);
#endif
...
#else
      v->value = savestring ("/helios/bin/shell", 17);
#endif
    }
}

...
char *
variable_buffer_output (ptr, mstring, length)
     char *ptr, *mstring;
     unsigned int length;
{
