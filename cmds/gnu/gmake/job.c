...
static char *rcsid = "$Header: /dsl/HeliosRoot/Helios/cmds/gnu/gmake/RCS/job.c,v 1.3 1992/06/27 11:40:24 bart Exp $"; 
...
#if !defined USG && !defined __HELIOS
      extern int getgroups ();
      static int groups[NGROUPS];
      static int ngroups = -1;
      if (ngroups == -1)
	ngroups = getgroups (NGROUPS, groups);
#endif	/* Not USG. or __HELIOS  */
