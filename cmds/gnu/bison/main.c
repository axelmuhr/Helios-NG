...
static char *rcsid = "$Header: /dsl/HeliosRoot/Helios/cmds/gnu/bison/RCS/main.c,v 1.1 1990/08/28 11:30:28 james Exp $";
...
char *fmt;
{
  ...
  _sprintf(buffer, fmt, x1,x2,x3,x4,x5,x6,x7,x8);
  fatal(buffer);
}
