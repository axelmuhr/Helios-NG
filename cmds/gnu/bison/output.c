...
static char *rcsid = "$Header: /dsl/HeliosRoot/Helios/cmds/gnu/bison/RCS/output.c,v 1.1 1990/08/28 11:33:23 james Exp $";
...
output_headers()
{
  ...
  _fprintf(faction, (semantic_parser ? ACTSTR : ACTSTR_SIMPLE), attrsfile);
