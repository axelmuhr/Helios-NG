...
static char *rcsid = "$Header: /usr/perihelion/Helios/cmds/gnu/diff/RCS/io.c,v 1.1 90/08/28 12:33:19 james Exp $";
...
/* Return 1 if BUF contains a character with the 0200 bit set.
