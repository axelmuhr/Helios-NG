...
static char *rcsid = "$Header: /usr/perihelion/Helios/cmds/gnu/diff/RCS/diff.c,v 1.1 90/08/28 12:28:52 james Exp $";
     ...
     char *argv[];
{
  ...
  while ((c = getopt (argc, argv, "0123456789abBcC:dD:efF:hHiI:lnNpqrsS:tTw"))
	 != EOF)
    {
      switch (c)
	{
...
usage ()
{
  ...
  fprintf (stderr,
    "            [-C lines] [-F regexp] [-I regexp] [-S file] [-D symbol]\n");
  fprintf (stderr,
    "            path1 path2\n");
  exit (1);
} 
