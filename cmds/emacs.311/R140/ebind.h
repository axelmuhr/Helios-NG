...
NOSHARE KEYTAB	keytab[NBINDS] = {
	...
	{CTRL|'N',		BINDFNC,	bforwline},
	{CTRL|'O',		BINDFNC,	openline},
	{CTRL|'P',		BINDFNC,	bbackline},
	...
	{META|CTRL|'A',		BINDFNC,	searchffold}, /* MJB: 21-Sep-89 */
	{META|CTRL|'B',		BINDFNC,	searchbfold}, /* MJB: 21-Sep-89 */
	{META|CTRL|'C', 	BINDFNC,	wordcount},
	{META|CTRL|'D',		BINDFNC,	delfold},     /* MJB: 21-Sep-89 */
	{META|CTRL|'E', 	BINDFNC,	execproc},
	{META|CTRL|'F', 	BINDFNC,	getfence},
	{META|CTRL|'G', 	BINDFNC,	gotomark},
	{META|CTRL|'H', 	BINDFNC,	delbword},
	{META|CTRL|'I',		BINDFNC,	exitfold},   /* MJB: 11-Sep-89 */
	{META|CTRL|'J',		BINDFNC,	removefold}, /* MJB: 11-Sep-89 */
	{META|CTRL|'K', 	BINDFNC,	unbindkey},
	{META|CTRL|'L', 	BINDFNC,	reposition},
	{META|CTRL|'M', 	BINDFNC,	delgmode},
	{META|CTRL|'N', 	BINDFNC,	namebuffer},
	{META|CTRL|'O',		BINDFNC,	closefold},  /* MJB: 11-Sep-89 */
	...
	{META|'I',		BINDFNC,	enterfold},  /* MJB: 11-Sep-89 */
	{META|'J',		BINDFNC,	makefold},   /* MJB: 11-Sep-89 */
	{META|'K',		BINDFNC,	bindtokey},
	{META|'L',		BINDFNC,	lowerword},
	{META|'M',		BINDFNC,	setgmode},
	{META|'N',		BINDFNC,	gotoeop},
	{META|'O',		BINDFNC,	openfold},   /* MJB: 11-Sep-89 */
...
#endif
	{META|'T',		BINDFNC,	exitallfolds}, /* MJB: 21-Sep-89 */
	...
	{SPEC|'N',		BINDFNC,	bforwline},	/* down */
	{SPEC|'V',		BINDFNC,	forwpage},	/* PgDn */
	{SPEC|'C',		BINDFNC,	(int(*)())insspace},	/* Ins */
...
*/
	...
	{SPEC|'b',		BINDFNC,	bbackline},	/* grey up */
	...
	{SPEC|'h',		BINDFNC,	bforwline},	/* grey down */
	{SPEC|'i',		BINDFNC,	forwpage},	/* grey PgDn */
	{SPEC|'j',		BINDFNC,	(int(*)())insspace},	/* grey Ins */
...
#if	HP150
	{SPEC|32,		BINDFNC,	bbackline},
	{SPEC|33,		BINDFNC,	bforwline},
	...
	{SPEC|0x48,		BINDFNC,	bbackline},
	{SPEC|0x50,		BINDFNC,	bforwline},
...
#if	AMIGA
	{SPEC|'?',		BINDFNC,	help},
	{SPEC|'A',		BINDFNC,	bbackline},
	{SPEC|'B',		BINDFNC,	bforwline},
