...
/* I don't know enough French!  MJB: 26-Oct-89 */
#define TEXT218 "[Fold Opened]"
#define TEXT219 "[Fold Closed]"
#define TEXT220 "[Fold Entered]"
#define TEXT221 "[Fold Exited]"
#define TEXT222 "%%Must fold at least 1 full line"
#define TEXT223 "[Fold Removed]"
#define TEXT224 "[Buffer folded]"
#define TEXT225 "%%Line is not a fold"
#define TEXT226 "%%Line is not within a fold"
#define TEXT227 "%%Folds too deep"
#define TEXT228 "%%Not within an entered fold"
#define TEXT229 "[Fold Deleted]"
#define TEXT230 "Missing end-fold Marker - "
#define TEXT231 "Missing start-fold Marker "
#define TEXT232 "%%Region contains incomplete folds"
#define TEXT233 "File extension: "
#define TEXT234 "Start fold text: "
#define TEXT235 "End fold text: "
#define TEXT236 "After fold text: "
#define TEXT237 "%%No fold markers defined for this type of file"
#define TEXT238 "%%Cannot AUTOSAVE when within entered fold"
