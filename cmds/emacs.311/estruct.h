...
#if defined(__SUN4) || defined(__SUN3)
...
#if defined(__SUN4) || defined(__SUN3) || defined(__RS6000)
...
#define CURSES  0	/* curses library ???				*/
...
#else
#ifdef __HELIOS
	/* Avoid problems with implicit cast, const char * -> char *	    */
#define CONST
#define VOID void
#define NOSHARE
#define SHARED 0
...
#if	MSC || TURBO || DTL || VMS || GCC || ZTC || __HELIOS
#define	PROTO	1
#else
#define	PROTO	0
#endif
...
#if	MSDOS | OS2 | V7 | USG | SMOS | HPUX | BSD | (TOS & MWC) | WMCS | SUN | MPE  | HELIOS 
#define	ENVFUNC	1
#else
#define ENVFUNC 0
#endif
...
#define FIODIR  7			/* Its a directory		*/
