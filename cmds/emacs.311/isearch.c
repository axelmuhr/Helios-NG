...
#if PROTO
int PASCAL NEAR reeat(int);	/* A local function type definition */
#else
int PASCAL NEAR reeat();	/* A local function type definition */
#endif
...
int PASCAL NEAR promptpattern(char *prompt)
{
    char tpat[NPAT+20];
