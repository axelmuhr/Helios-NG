...
PASCAL NEAR delwind(
  int f,
  int n )	/* arguments are ignored for this command */
{
...
PASCAL NEAR nextup(	/* scroll the next window up (back) a page */
...
PASCAL NEAR nextdown(	/* scroll the next window down (forward) a page */
...
PASCAL NEAR savewnd(	/* save ptr to current window */
...
PASCAL NEAR restwnd(	/* restore the saved screen */
...
PASCAL NEAR newsize(	/* resize the screen, re-writing the screen */
...
PASCAL NEAR newwidth(	/* resize the screen, re-writing the screen */
...
PASCAL NEAR new_col_org(	/* reposition the screen, re-writing the screen */
...
PASCAL NEAR new_row_org(	/* reposition the screen, re-writing the screen */
