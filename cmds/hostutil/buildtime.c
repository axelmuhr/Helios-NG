/*---------------------------------------------------------------------------*/
/*      File: buildtime.c
 * SubSystem: Helios-ARM host tools
 * $Revision: 1.1 $
 *   $Author: vlsi $
 *     $Date: 1994/06/08 09:05:05 $
 *
 * This program constructs an "armasm" assembler file containing
 * variables defining the time and date of the execution of the
 * program.
 *
...
#define cfile       "timedate.s"    /* default destination header file */
