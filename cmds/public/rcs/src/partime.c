...
#ifndef lint
static char rcsid[]=
"$Header: /usr/perihelion/Helios/cmds/gnu/rcs/src/RCS/partime.c,v 1.6 90/01/02 11:20:24 chris Exp $";
#endif

/* $Log:	partime.c,v $
 * Revision 1.6  90/01/02  11:20:24  chris
 * Helios port
 * 
...
struct tmwent tmwords [] = {
	...
	{"at",           0/*(long)(&ptnoise)*/, TWSPEC, 0},    /* Noise word */
