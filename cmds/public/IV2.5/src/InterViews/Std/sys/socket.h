/*	@(#)socket.h 1.5 88/02/01 SMI; from UCB 4.27 83/05/27	*/
...
#define	SOCK_EVENT    	10		/* event/message-oriented interface */
...
#define AF_ERROR	AF_UNSPEC	/* error	*/
...
#define AF_802		13		/* IEEE 802.2, also ISO 8802 */
#define AF_OSI		14		/* umbrella for all AF* families used 
					 * by OSI (used for protosw lookup) */
#define AF_GENERIC	15		/* error */
#define AF_OSINET	16		/* AFI = 47, IDI = 4 */
#define AF_CONS_1980	17		/* AFI = 36, 37		 */
#define	AF_ENE		18
...
#define MSG_OSI_OOB     0x8     	/* process OSI out-of-band event */
