...
/*
static char *rcsid = "$Header: /hsrc/cmds/debugger/lib/TRAN/RCS/dlib.c,v 1.5 1993/05/18 11:56:50 nickc Exp $";
*/
...
PRIVATE Object *locatecode(void)
{
  ...
  MachineName(name);
  strcat(name, "/loader/");
  strcat(name, ((Program *)MyTask->Program)->Module.Name);
...
PRIVATE BOOL initdebug(void)
{
  ...
  */
...
#endif
  {
    ...
    */
    unless  ((dbgstream = Open(debugger, ((Program *)MyTask->Program)->Module.Name, O_ReadWrite | O_Create)) == NULL)
    {
/*
...
{
  word *modtab;
  Module *module = &((Program *)MyTask->Program)->Module;
  word maxid = 0;
  word maxdata = 0;
  ...
  until (module->Type == 0)
  {
    ...
    if (module->Id == DLib_Slot) maxdata = ((Module *)((ResRef *)module)->Module)->MaxData;
