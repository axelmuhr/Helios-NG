 ...
 *
 * $Header: /hsrc/cmds/emacs/RCS/display.c,v 1.2 1992/12/08 15:37:18 nickc Exp $
 *
 */
...
int c;
{
	VIDEO *vp = vscreen[vtrow];	/* ptr to line being updated */
	char *text= vp->v_text;		/* ptr to text base */
	if (c == '\t') {
		do {
			vtputc(' ');
